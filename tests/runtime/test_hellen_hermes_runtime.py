"""Tests for hellen.runtime — HellenHermesRuntime and cancel_llm_call (HLD 3.8.1, 3.8.3).

Covers:
- HellenHermesRuntime implements Runtime ABC
...
class TestHellenHermesRuntimeABC:
    """Test HellenHermesRuntime satisfies the Runtime ABC."""

    def test_is_runtime_subclass(self):
        """HellenHermesRuntime is a subclass of Runtime."""
        assert issubclass(HellenHermesRuntime, Runtime)

    def test_instantiable(self):
        """Can instantiate HellenHermesRuntime without errors."""
        runtime = HellenHermesRuntime()
...
class TestCancelLlmCall:
    ...
    def test_cancel_completed_call(self):
        ...
        runtime = HellenHermesRuntime(llm_runtime=mock_llm)
...
class TestMemoryOperations:
    ...
    def setup_method(self):
        self.runtime = HellenHermesRuntime()
...
class TestResolveImport:
    ...
    def test_no_resolver_raises(self):
        ...
        runtime = HellenHermesRuntime()
        try:
            runtime.resolve_import("./module", "./main.hellen")
            assert False, "Should have raised"
        except RuntimeError as e:
    ...
    def test_delegates_to_resolver(self):
        ...
        runtime = HellenHermesRuntime(import_resolver=mock_resolver)
        result = runtime.resolve_import("./module", "./main.hellen")
        mock_resolver.resolve.assert_called_once_with("./module", "./main.hellen")
