"""Hellen Language Server Protocol implementation (HLD M12).
...
# ── Hellen keywords for completion ─────────────────────────────
...
class HellenLanguageServer:
    """LSP server for the Hellen language.
    ...
    def _analyze(self, content: str) -> list[Diagnostic]:
        ...
        try:
            from hellen.core.errors import ErrorReporter  # noqa: PLC0415
            ...
            # hellen package not available, skip analysis
            pass
