...
Formats HellenError and HellenWarning with SourceSpan into
...
if TYPE_CHECKING:
    from hellen.core.errors import HellenError, HellenWarning  # noqa: F401
    from hellen.core.source import SourceSpan  # noqa: F401


def format_error(error: "HellenError", source_lines: list[str] | None = None) -> str:
    """Format a HellenError into HLD 3.11.2 diagnostic output.
...
def format_warning(warning: "HellenWarning", source_lines: list[str] | None = None) -> str:
    """Format a HellenWarning into HLD 3.11.2 diagnostic output.
...
def _format_diagnostic(
    label: str,
    diagnostic: "HellenError | HellenWarning",
