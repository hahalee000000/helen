...
- **Original path**: `~/.hermes/skills/software-development/writing-plans/`
- **License**: MIT
- **Original author**: Hermes Agent (adapted from obra/superpowers)
...
- No content changes — skill is fully platform-agnostic
