...
| [10](#教程-10:-标准库参考) | 教程 10: 标准库参考 — 200 个内置函数，覆盖 AI 应用开发的所有核心需求 |
...
**中文关键字映射**：`让`=let, `函数`=fn, `如果`=if, `否则`=else, `返回`=return, `真`=true, `假`=false, `空`=null 等 44 个。详见 [[syntax/keywords|关键字参考]]。
