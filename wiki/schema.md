...
│
├── guide/                # Beginner guide — agent-first pedagogical narrative (11 chapters + appendix)
│   ├── README.md
│   ├── 01-hello-agent.md
│   ├── 02-prompt.md
│   ├── 03-llm-statements.md
│   ├── 04-tools.md
│   ├── 05-basics.md
│   ├── 06-control-flow.md
│   ├── 07-functions.md
...
│   └── appendix.md
│
├── reference/            # Language reference manual (18 chapters, by topic)
...
---
title: Page Title
type: entity | concept | reference | guide | appendix
created: YYYY-MM-DD
updated: YYYY-MM-DD
version: v1.18
...
- `[[reference/05-agents]]` — Agent programming reference
