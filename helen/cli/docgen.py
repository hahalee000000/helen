"""Documentation generator for Helen (HLD Phase 7).
...
def parse_source(source: str, source_file: str = "") -> ProgramNode | None:
    """Parse Helen source into a ProgramNode."""
...
def generate_docs(
    ...
    Args:
        source_files: List of .helen file paths.
...
def generate_cli() -> int:
    """CLI entry point for docgen: `helen doc <files...> [--format markdown|json]`."""
    import argparse  # noqa: PLC0415

    parser = argparse.ArgumentParser(description="Generate Helen documentation")
    parser.add_argument("files", nargs="*", help=".helen source files")
    parser.add_argument(
